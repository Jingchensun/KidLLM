...
def load_sft_dataset(args):
    ...
    '''
    data = SupervisedDatasetAudio(args['data_path'], args['image_root_path'])
...
def load_sft_dataset_val(args):
    ...
    data = globals()[dataset_name](data_path, tokenizer, args['max_length']) #SupervisedDataset
    '''
    data = SupervisedDatasetAudio(args['test_data_path'], args['image_root_path'])
